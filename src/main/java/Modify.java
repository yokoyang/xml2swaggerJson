 ...
 * */
public class Modify {
    //TODO 扫描，把变量类型修改为swagger支持的类型
    private String path;
    private final String target;
    private final String newContent;
    public static String HOSTNAME = "slcdemo.cfapps.sap.hana.ondemand.com";
        ...
        try {
            ...
            while (true) {
                ...
                if (str.contains(target)) {
                    String a = str.replace(target, newContent);
                    writer.write(a + "\n");
    ...
    public static void main(String[] args) {
        ...
        String path = "C:\\Users\\i332340\\Desktop\\scp\\makeSwagger\\src\\main\\resources\\apis";
//        new Modify(path, "Edm.String", "string");
//        new Modify(path, "Edm.Int32", "integer");
//        new Modify(path, "Edm.Double", "number");
//        new Modify(path, "Edm.DateTime", "string");
//        {Host}:{Port}
//        new Modify(path, "{Host}:{Port}", HOSTNAME);
        new Modify(path, "slc.cfapps.sap.hana.ondemand.com", HOSTNAME);
